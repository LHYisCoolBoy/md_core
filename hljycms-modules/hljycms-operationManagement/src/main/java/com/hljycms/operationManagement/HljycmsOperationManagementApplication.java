package com.hljycms.operationManagement;
...
public class HljycmsOperationManagementApplication
{
    public static void main(String[] args)
    {
        SpringApplication.run(HljycmsOperationManagementApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  operationManagement模块启动成功   ლ(´ڡ`ლ)ﾞ  \n");
    }
}
