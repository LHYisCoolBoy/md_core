...
import com.cms.common.core.constant.HttpStatus;
...
public class BaseController {
    ...
    protected TableDataInfo getDataTable(List<?> list) {
        ...
        Double total = (double) new PageInfo(list).getTotal();

        PageDomain pageDomain = TableSupport.buildPageRequest();
        Double pageSize = (double) pageDomain.getPageSize();
        ...
        rspData.setTotalPage((long) Math.ceil(total / pageSize));
        return rspData;
    }
